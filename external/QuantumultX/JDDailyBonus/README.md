...
本项目的京东多合一签到脚本复写规则由爬虫程序自动维护。

定时爬取互联网上开源的京东多合一签到脚本复写规则，将其进行清洗、去重、合并、转换，以解决引用大量外部复写造成重复问题，或对上游仓库复写进行备份。
...
本项目的京东多合一签到脚本复写规则的数据来自以下链接，通常已涵盖所有数据来源的复写规则。如果你正在使用这些复写规则，建议不要与本项目的京东多合一签到脚本复写规则混合使用，以免造成规则重复。
...
欢迎通过[issues](https://github.com/blackmatrix7/ios_rule_script/issues/new)提交反馈，共同完善本项目的京东多合一签到脚本复写规则。
